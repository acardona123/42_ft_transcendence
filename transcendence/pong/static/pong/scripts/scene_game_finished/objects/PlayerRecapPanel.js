class PlayerRecapPanel extends Phaser.GameObjects.Container{
	...
	constructor(
		...
		#createComponents(){
			...
			#createIcon(){
				this.#icon = new Icon(this.#player_index_symbol, this.#player_texture, gameConfig.scene_game_finished.panel.icon_size)
			}
		...
		#positionComponents(){
			...
			this.depth = gameConfig.scene_game_finished.depths.panel;
		}
	...
	playCelebrationTween(){
		...
		#playCelebrationJump(){
			...
			this.#scene.tweens.chain({
				...
				tweens: [
					{
						y: initial_icon_y - gameConfig.scene_game_finished.panel.celebration.jump_height,
						angle: gameConfig.scene_game_finished.panel.celebration.jump_angle,
						duration: gameConfig.scene_game_finished.panel.celebration.jump_duration,
						ease: 'quad.out'
					},
					{
						y: initial_icon_y,
						angle: 0,
						duration: gameConfig.scene_game_finished.panel.celebration.bounce_duration,
						ease: 'bounce.out'
					},
				],
				loop: -1,
				loopDelay: gameConfig.scene_game_finished.panel.celebration.loop_delay,
			});
		}
			...
			tweens: [
				{
					...
					angle: gameConfig.scene_game_finished.panel.defeat.kneeing_angle / 2,
					duration: 1000,
					ease: 'Power1',
					repeat: 0,
				},
				{
					angle: {
						from: gameConfig.scene_game_finished.panel.defeat.kneeing_angle / 2,
						to: gameConfig.scene_game_finished.panel.defeat.kneeing_angle
					},
					duration: 2000,
					ease: 'Sine.easeInOut',
					yoyo: true,
