	...
	create(){
		...
		#createPlayerPanels(){
			...
			#positionPayerPanels(){
				...
				#positionPayer1Panel(){
					this.#panel_player1.setTopRightCornerPosition(0, gameConfig.scene_game_finished.padding.top);
				...
				#positionPayer2Panel(){
					this.#panel_player2.setTopLeftCornerPosition(gameConfig.width, gameConfig.scene_game_finished.padding.top);
		...
		#createMatchDurationDisplay(){
			...
			this.#match_duration.depth = gameConfig.scene_game_finished.depths.match_duration;
		}
		...
		#createQuitButton(){
			...
			#positionButton(){
				...
				const y = this.#match_duration.y + this.#match_duration.height / 2 +  gameConfig.scene_game_finished.padding.under_match_duration;
				this.#quit_button.setTopCenterPosition(x, y);
				this.#quit_button.depth = gameConfig.scene_game_finished.depths.button;
			}
