	...
	constructor(
		...
		#createComponents(){
			...
			#createIcon(){
				...
				#resizeIconObject(){
					const scale_x = this.#player_texture.getScaleToTargetWidth(gameConfig.scene_menu.panel.icon_size);
					const scale_y = this.#player_texture.getScaleToTargetHeight(gameConfig.scene_menu.panel.icon_size);
		...
		#resizeContainer(){
			this.width = Math.max(gameConfig.scene_menu.panel.icon_size, this.#text_username.width, this.#text_controls.width);
			this.height = gameConfig.scene_menu.panel.icon_size + gameConfig.scene_menu.panel.icon_bottom_padding
				+ this.#text_username.height + gameConfig.scene_menu.panel.line_spacing
		...
		#positionComponents(){
			...
			this.depth = gameConfig.scene_menu.depth.panel;
		}
			...
			#setComponentsPosition(){
				...
				y += gameConfig.scene_menu.panel.icon_size + gameConfig.scene_menu.panel.icon_bottom_padding;
				this.#text_username.setPosition(0, y);
				y +=  this.#text_username.height + gameConfig.scene_menu.panel.icon_bottom_padding;
