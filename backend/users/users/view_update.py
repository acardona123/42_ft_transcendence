...
from .doc import (JWT_TOKEN, MSG_ERROR_UPDATE_PASSWORD_OAUTH,
		MSG_ERROR_UPDATE_PASSWORD, MSG_ERROR_UPDATE_USER_INFO, MSG_PASSWORD_UPDATE,
		MSG_INFO_USER_UPDATE, DOC_ERROR_UPDATE_PASSWORD,
		DOC_IMPOSSIBLE_UPDATE_PASSWORD, DOC_UPDATE_PASSWORD, DOC_ERROR_UPDATE_INFO,
		DOC_UPDATE_INFO, DOC_ERROR_UNAUTHORIZED, DOC_ERROR_METHOD_NOT_ALLOWED)
