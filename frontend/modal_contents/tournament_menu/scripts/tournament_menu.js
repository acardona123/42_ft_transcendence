...
async function tournament_add_player(player_data)
{
	...
	{
		create_popup("Error while adding a new player. Try again.", 4000, 4000, HEX_RED, HEX_RED_HOVER);
	}
}
...
async function submit_tournament_validation(tournament_data)
{
	...
	catch (error)
	{
		...
		create_popup("Error while validate tournament. Try again.", 4000, 4000, HEX_RED, HEX_RED_HOVER);
		alert("Error while creating tournament. You can try again if you want.")
	}
}
