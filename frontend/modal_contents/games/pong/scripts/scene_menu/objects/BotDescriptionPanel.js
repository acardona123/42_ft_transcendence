class pg_BotDescriptionPanel extends Phaser.GameObjects.Container{
	#scene;
	#player_icon_texture;
	#text_style;
	...
	constructor(
		...
		#createComponents(){
			...
			#createTextBotLevel(){
				this.#text_bot_level = this.#createTextObject(`Level: ${pg_gameMode.bot_level}`);
			}

		#resizeContainer(){
			this.width = Math.max(pg_gameConfig.scene_menu.player_panel.icon_size, this.#text_bot_name.width, this.#text_bot_level.width);
			this.height = pg_gameConfig.scene_menu.player_panel.icon_size
				...
				+ pg_gameConfig.scene_menu.player_panel.line_spacing;
		}
		...
		#positionComponents(){
			...
			#setComponentsPosition(){
				...
				y +=  this.#text_bot_name.height + pg_gameConfig.scene_menu.player_panel.line_spacing;
